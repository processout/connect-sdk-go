...
// Documentation can be found at https://epayments-api.developer-ingenico.com/s2sapi/v1/en_US/go/disputes/get.html
//
...
func (c *Client) Get(disputeID string, context communication.CallContext) (dispute.Response, error) {
...
// Documentation can be found at https://epayments-api.developer-ingenico.com/s2sapi/v1/en_US/go/disputes/submit.html
//
// Can return any of the following errors:
// * ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
// * AuthorizationError if the request was not allowed (HTTP status code 403)
...
// or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)
// * APIError if the Ingenico ePayments platform returned any other error
func (c *Client) Submit(disputeID string, context communication.CallContext) (dispute.Response, error) {
	var resultObject dispute.Response
...
// Documentation can be found at https://epayments-api.developer-ingenico.com/s2sapi/v1/en_US/go/disputes/cancel.html
//
// Can return any of the following errors:
// * ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
// * AuthorizationError if the request was not allowed (HTTP status code 403)
...
// or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)
// * APIError if the Ingenico ePayments platform returned any other error
func (c *Client) Cancel(disputeID string, context communication.CallContext) (dispute.Response, error) {
	var resultObject dispute.Response
...
// or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)
// * APIError if the Ingenico ePayments platform returned any other error
func (c *Client) UploadFile(disputeID string, body UploadFileRequest, context communication.CallContext) (dispute.UploadDisputeFileResponse, error) {
	var resultObject dispute.UploadDisputeFileResponse
...
//
// parent is the *apiresource.APIResource on top of which we want to build the new Disputes Client
