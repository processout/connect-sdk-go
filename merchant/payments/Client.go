...
import (
	...
	"github.com/processout/connect-sdk-go/domain/capture"
...
// Documentation can be found at https://epayments-api.developer-ingenico.com/s2sapi/v1/en_US/go/payments/devicefingerprint.html
//
// Can return any of the following errors:
// * ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
// * AuthorizationError if the request was not allowed (HTTP status code 403)
...
func (c *Client) Devicefingerprint(paymentID string, context communication.CallContext) (payment.DeviceFingerprintDetails, error) {
	var resultObject payment.DeviceFingerprintDetails
